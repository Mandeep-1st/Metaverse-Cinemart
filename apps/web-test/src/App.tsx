              ...
              {THEMES.map((theme) => (
                <button
                  ...
                  className={`w-full px-4 py-2 text-left hover:bg-primary hover:text-white transition-colors capitalize ${
                    currentTheme === theme ? "bg-primary text-white font-bold" : ""
                  }`}
                >
                  {theme}
                </button>
      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-surface border-2 border-primary rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-primary mb-4">Movie Details</h3>
            <div className="space-y-2">
              <p className="text-foreground"><span className="font-semibold">TMDB ID:</span> {movie.tmdbId}</p>
              <p className="text-foreground"><span className="font-semibold">Trailer:</span> {movie.trailerKey}</p>
              <p className="text-foreground"><span className="font-semibold">Cast:</span> {movie.cast.length} members</p>
            </div>
          </div>
          ...
          <div className="bg-surface border-2 border-primary rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-primary mb-4">Form Elements</h3>
            <div className="space-y-3">
              <input
                type="text"
          ...
          <div className="bg-surface border-2 border-primary rounded-lg p-6 shadow-lg">
            ...
            <div className="space-y-2">
              ...
              <p className="text-foreground/70 text-sm">Muted text for secondary information.</p>
            </div>
          </div>

          {/* Card 5 - Status Badges */}
          <div className="bg-surface border-2 border-primary rounded-lg p-6 shadow-lg">
            <h3 className="text-2xl font-bold text-primary mb-4">Status Badges</h3>
            <div className="space-y-3">
              <div className="flex flex-wrap gap-2">
                <span className="bg-primary text-white px-3 py-1 rounded-full text-sm font-semibold">Active</span>
                <span className="bg-background text-foreground px-3 py-1 rounded-full text-sm border-2 border-primary">Pending</span>
                <span className="bg-surface text-primary px-3 py-1 rounded-full text-sm font-semibold border border-primary">Featured</span>
              </div>
              <div className="flex flex-wrap gap-2">
        ...
        <div className="bg-surface border-2 border-primary rounded-lg p-8 shadow-lg">
          <h3 className="text-3xl font-black text-primary mb-6 uppercase italic">Full Width Content Area</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-xl font-bold text-foreground mb-3">Left Column</h4>
              <p className="text-foreground mb-3">
                This is a comprehensive theme testing dashboard. It includes various UI components to help you visualize how different theme presets affect the overall design.
              </p>
            ...
            <div>
              <h4 className="text-xl font-bold text-foreground mb-3">Right Column</h4>
              <div className="bg-background border border-primary rounded p-4 mb-3">
                <p className="text-foreground/80 text-sm italic">
                  "Use the floating theme switcher in the top-right corner to quickly test different presets."
                </p>
              </div>
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="text-foreground">Theme Count:</span>
                  <span className="text-primary font-bold">{THEMES.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-foreground">Current Theme:</span>
                  <span className="text-primary font-bold capitalize">{currentTheme}</span>
                </div>
              </div>
            </div>
          </div>
